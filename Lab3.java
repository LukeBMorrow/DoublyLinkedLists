...
public class Lab3 {
    ...
    private static final int NUM_ITEMS = 20; // How many random items to put in the test list.
...
class List {
    ...
    ******************/
    ...
    private void remove(DNode nodeToBeRemoved)
    {
        if( nodeToBeRemoved.getForward()!=null && nodeToBeRemoved.getBack()!=null) {
            nodeToBeRemoved.getBack().setForward(nodeToBeRemoved.getForward());
            nodeToBeRemoved.getForward().setBack(nodeToBeRemoved.getBack());
        }
        else if(nodeToBeRemoved.getBack()!=null)
            nodeToBeRemoved.getBack().setForward(null);
        else
            start = nodeToBeRemoved.getForward();
    ...
    *
    ******************/
    private List partition( DNode pivot ) { // returns the smalls in a new list, the bigs in "this"

	// ***************** YOUR CODE GOES HERE ***************************
        List smalls = new List();
        DNode curr = start;
        DNode temp;
    ...
    ******************/
	...
	// ***************** YOUR CODE GOES HERE ***************************
        int distToMiddle = listLength()/2;
        DNode curr = start;
        while(distToMiddle>0)
        {
            curr=curr.getForward();
            distToMiddle--;
        }
